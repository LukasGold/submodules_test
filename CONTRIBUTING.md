...
Welcome to `submodules_test` contributor's guide.
...
If you experience bugs or general issues with `submodules_test`, please have a look
...
You can help improve `submodules_test` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`submodules_test` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `submodules_test`'s files. While this mechanism can
...
```
conda create -n submodules_test python=3 six virtualenv pytest pytest-cov
conda activate submodules_test
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/submodules_test.git
   cd submodules_test
   ```
...
5. Install [pre-commit]:
   ...
   `submodules_test` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/submodules_test
[issue tracker]: https://github.com/<USERNAME>/submodules_test/issues
